...
module.exports.sendResetPasswordEmail = (name, email, confirmationCode) => {
    transport
        .sendMail({
            from: user,
            to: email,
            subject: "[DevaHealthAssistant] Please reset your password",
            html: `<h1>Reset your account's password </h1>
        <h2>DevaHealthAssistant password reset</h2>
...
module.exports.sendAppointementMail = (
    docname,
    doclastname,
    StartDate,
    docphone,
    ...
    transport
        .sendMail({
            from: user,
            to: Email,
            subject: "[DevaHealthAssistant] Appointement Confirmation",
